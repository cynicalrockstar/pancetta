...
namespace Pancetta.Windows
{
    ...
    public sealed partial class MainPage : Page, IMainPage, IBackendActionListener
    {
        ...
        public MainPage()
        {
            ...
            ApplicationView.GetForCurrentView().TitleBar.ButtonBackgroundColor = ((SolidColorBrush)Application.Current.Resources["SystemControlBackgroundAccentBrush"]).Color;
            ApplicationView.GetForCurrentView().TitleBar.InactiveBackgroundColor = ((SolidColorBrush)Application.Current.Resources["SystemControlBackgroundAccentBrush"]).Color;
            ApplicationView.GetForCurrentView().TitleBar.ButtonInactiveBackgroundColor = ((SolidColorBrush)Application.Current.Resources["SystemControlBackgroundAccentBrush"]).Color;
            ApplicationView.GetForCurrentView().TitleBar.ForegroundColor = ((SolidColorBrush)Application.Current.Resources["SystemControlForegroundBaseHighBrush"]).Color;
            ApplicationView.GetForCurrentView().TitleBar.InactiveForegroundColor = ((SolidColorBrush)Application.Current.Resources["SystemControlForegroundBaseHighBrush"]).Color;
            ApplicationView.GetForCurrentView().TitleBar.ButtonForegroundColor = ((SolidColorBrush)Application.Current.Resources["SystemControlForegroundBaseHighBrush"]).Color;
            ApplicationView.GetForCurrentView().TitleBar.ButtonInactiveForegroundColor = ((SolidColorBrush)Application.Current.Resources["SystemControlForegroundBaseHighBrush"]).Color;
